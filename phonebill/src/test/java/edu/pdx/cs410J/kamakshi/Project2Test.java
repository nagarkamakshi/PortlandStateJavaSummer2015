...
public class Project2Test extends InvokeMainTestCase {
    ...
    public void testTextFileCommandWithReadMe(){
        ...
        //assertEquals(new Integer(1), result.getExitCode());
       assertThat(result.getOut(),containsString("This is a README for java Project1 : Designing a Phone Bill Application at Portland State University Summer 2015, created by Kamakshi Nagar."));
    }
    @Test
    ...
    public void testAllPrintsCorrectOutputForATextFile(){
        MainMethodResult result = invokeMain("-textFile","read.txt","Jams","999-999-9999","000-000-0000","11/15/2015","9:39","11/02/2015","01:03");
        assertThat(result.getOut(),containsString("Customer: Jams"));
        assertEquals(result.getExitCode(), new Integer(1));
    }
    @Test
    public void testAllPrintsInCorrectOutputForExistingTextFile(){
        MainMethodResult result = invokeMain("-textFile","read.txt");
        //assertThat(result.getOut(),containsString("hkjhk"));
        assertEquals(result.getExitCode(), new Integer(1));

    }
    @Test
    public void testAllPrintsInCorrectOutputForNonExistingTextFile(){
        MainMethodResult result = invokeMain("-textFile","kama.txt");
        //assertThat(result.getOut(),containsString("hkjhk"));
        assertEquals(result.getExitCode(), new Integer(1));
    ...
    public void testIncorrectOptionExitWithError(){
        ...
        assertThat(result.getOut(),containsString("Invalid Command line Option"));
        assertEquals(result.getExitCode(), new Integer(1));
